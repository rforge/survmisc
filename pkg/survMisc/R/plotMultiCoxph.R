...
##' @export
##' @title Plot \code{multi.coxph} object
...
##' \cr \cr
##' If \code{type="p"} then points representing the information criterion (IC)
...
##' be appropriate.
##' \cr \cr
##' If \code{type="w"} then the weights (relative evidence weights) of the
...
##' \cr \cr
##' If \code{type="s"} then the sum of the relative evidence weights for
