...
##' @docType data
##' @title Air data
##' @details A data frame with 111 observations (rows), and 4 variables (columns), taken from an environmental study that measured the four variables ozone, solar radiation, temperature, and wind speed for 111 consecutive days.
##' @format A data frame with 111 rows and 4 columns
##' \cr \cr
##' Columns are:
##' \describe{
