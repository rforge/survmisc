...
#' (although admittedly less efficient).
#' A more detailed discussion of the issues involved in multiple model
#' fittting is presented in the reference paper describing
...
#' }
#' The models are returned in a \code{data.table} with one row per model giving the fitted coefficients,
#' the IC for the model and the relative evidence weights.
#' @note A multi-threaded version is planned.
#' \cr \cr
